...
export default function SignInPage() {
  const { signIn, isSigningIn, authError, clearAuthError, setAuthError } =
    useAuth();
  ...
  return (
    <div className="px-4 py-10">
      <section className="mx-auto w-full max-w-md rounded-2xl border bg-white shadow-xl p-6">
        <h1 className="text-3xl font-bold text-yellow-500 flex justify-center">
          Đăng nhập tài khoản
        </h1>
        <p className="mt-2 text-sm text-slate-600">
          Điền thông tin bên dưới để đăng nhập vào tài khoản PizzaPalace của
          bạn.
        </p>
